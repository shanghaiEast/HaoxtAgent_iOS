...
- (void)viewWillAppear:(BOOL)animated {
    ...
    [MyTools setViewController:self withNavigationBarColor:WHITECOLOR andItem:@"交易详情" itemColor:WHITECOLOR haveBackBtn:YES withBackImage:defaultBarBackImage_black withBackClickTarget:self BackClickAction:@selector(popViewClick)];

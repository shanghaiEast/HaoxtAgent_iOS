//
//  FilterReturnsDetailedHeaderView.m
//  YanFarmwork
//
...
@interface FilterReturnsDetailedHeaderView ()

@property (retain, nonatomic) FilterTimeView *timeView;

@end

@implementation FilterReturnsDetailedHeaderView
...
- (void)createStateBtn{
    ...
    NSArray *stateArray = @[@"全选",@"入账",@"提现",@"手续费",@"税费",@"提现退款",@"调账"];
    float btnWidth = 70;
    float btnHeight = 30;

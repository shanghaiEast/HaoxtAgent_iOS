//
//  PurchasingApplicationViewController.m
//  YanFarmwork
//
...
@interface PurchasingApplicationViewController() <UITableViewDelegate, UITableViewDataSource,UIImagePickerControllerDelegate, UINavigationControllerDelegate>


@property (retain, nonatomic) PurchasingApplicationHeaderView *headerView;
...
@implementation PurchasingApplicationViewController
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    [MyTools setViewController:self withNavigationBarColor:WHITECOLOR andItem:@"采购申请" itemColor:BLACKCOLOR haveBackBtn:YES withBackImage:defaultBarBackImage_black withBackClickTarget:self BackClickAction:@selector(popViewClick)];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    _headerView = [[[NSBundle mainBundle] loadNibNamed:@"PurchasingApplicationHeaderView" owner:self options:nil] lastObject];

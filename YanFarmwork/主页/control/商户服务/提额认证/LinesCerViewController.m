...
@interface LinesCerViewController ()<UITableViewDelegate, UITableViewDataSource>

@end

@implementation LinesCerViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    static NSString *topCell = @"LinesCerTableViewCell";
    LinesCerTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:topCell];
    if (cell == nil) {

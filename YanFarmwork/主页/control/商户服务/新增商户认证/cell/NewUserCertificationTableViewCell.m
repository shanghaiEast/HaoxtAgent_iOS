//
//  NewUserCertificationTableViewCell.m
//  YanFarmwork
//
...
#import "NewUserCertificationTableViewCell.h"

#import "NewUserStatementViewController.h"
...
@interface NewUserCertificationTableViewCell ()<cwIdCardRecoDelegate>
...
@implementation NewUserCertificationTableViewCell
...
- (IBAction)nextBtnClick:(id)sender {
    ...
    NewUserStatementViewController *userStatementVC = [[NewUserStatementViewController alloc] initWithNibName:@"NewUserStatementViewController" bundle:nil];
    userStatementVC.hidesBottomBarWhenPushed = YES;
    [self.rootVC.navigationController pushViewController:userStatementVC animated:YES];

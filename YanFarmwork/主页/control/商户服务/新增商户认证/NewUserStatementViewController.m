//
//  NewUserStatementViewController.m
//  YanFarmwork
//
...
@interface NewUserStatementViewController ()<UITableViewDelegate, UITableViewDataSource>

@end

@implementation NewUserStatementViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    static NSString *topCell = @"NewUserStatementTableViewCell";
    NewUserStatementTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:topCell];
    if (cell == nil) {

//
//  NewUserCertificationViewController.m
//  YanFarmwork
//
...
@interface NewUserCertificationViewController ()<UITableViewDelegate, UITableViewDataSource>

@end

@implementation NewUserCertificationViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    static NSString *topCell = @"NewUserCertificationTableViewCell";
    NewUserCertificationTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:topCell];
    if (cell == nil) {

...
@interface ShopNewSearchViewController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation ShopNewSearchViewController
...
- (UIView *)searchViewCreate{
    ...
    if (_searchType == SEARCH_SHOP) {
         _searchTextField.placeholder = @"请输入业务员编号/名称";
    }else if (_searchType == SEARCH_TERMINAL) {
         _searchTextField.placeholder = @"好友称号/编号";
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (_searchType == SEARCH_SHOP) {
        static NSString *topCell = @"ShopManagerTableViewCell";
        ShopManagerTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:topCell];
        if (cell == nil) {

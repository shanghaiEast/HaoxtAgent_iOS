//
//  TrendChartLineViewController.m
//  YanFarmwork
//
...
@interface TrendChartLineViewController ()<UITableViewDelegate, UITableViewDataSource, JXCategoryViewDelegate>
...
@implementation TrendChartLineViewController
...
- (void)screenClicked {
    ...
    if (_chartsLineType == CHANRTS_LINE_JIHUO) {
    ...
    if (_chartsLineType == CHANRTS_LINE_SHOUYI) {
        ...
        VC.listSYType = CHANRTS_LINE_SHOUYI;
        VC.hidesBottomBarWhenPushed = YES;
        [self.navigationController pushViewController:VC animated:YES];
    }
    
    if (_chartsLineType == CHANRTS_LINE_JIAOYI) {
        NewChartListViewController *VC = [[NewChartListViewController alloc] initWithNibName:@"NewChartListViewController" bundle:nil];
        VC.listType = CHANRTS_LINE_JIAOYI;
        VC.hidesBottomBarWhenPushed = YES;
        [self.navigationController pushViewController:VC animated:YES];
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    static NSString *nibString = @"TrendChartLineTableViewCell";;
    TrendChartLineTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:nibString];
    if (cell == nil) {
    ...
    if (_chartsLineType == CHANRTS_LINE_JIHUO) {
        cell.titleLabel.text = @"激活激活统计趋势图";
    }
    if (_chartsLineType == CHANRTS_LINE_JIAOYI) {
        cell.titleLabel.text = @"交易激活统计趋势图";
    }
    if (_chartsLineType == CHANRTS_LINE_SHOUYI) {
        cell.titleLabel.text = @"收益激活统计趋势图";
    }
